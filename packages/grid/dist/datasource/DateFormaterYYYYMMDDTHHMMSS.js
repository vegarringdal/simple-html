...
export class DateFormaterYYYYMMDDTHHMMSS {
    ...
    static toSource(value) {
        ...
        const YYYYMMDD = dateTime[0].split('-');
        ...
        returnValue = new Date(YYYYMMDD[0], parseInt(YYYYMMDD[1], 10) - 1, parseInt(YYYYMMDD[2], 10), parseInt(HHMMSS[0], 10), parseInt(HHMMSS[1], 10), parseInt(HHMMSS[2], 10), new Date().getMilliseconds());
    ...
    static fromSourceDisplay(value) {
        return DateFormaterYYYYMMDDTHHMMSS.fromSource(value);
    }
    static fromSourceGrouping(value) {
        return DateFormaterYYYYMMDDTHHMMSS.fromSourceDisplay(value);
    }
    static placeholder() {
        return 'YYYY-MM-DDTHH:MM:SS';
    }
}
//# sourceMappingURL=DateFormaterYYYYMMDDTHHMMSS.js.map