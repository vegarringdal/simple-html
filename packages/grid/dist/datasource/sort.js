                ...
                if (v1 !== v2) {
                    if (currentObj.ascending === true) {
                        ...
                        if (isDate) {
                            ...
                            if (v1?.getTime) {
                                vv1 =
                                    new Date(new Date(v1).getFullYear(), new Date(v1).getMonth(), new Date(v1).getDate(), 0, 0, 0, 0).getTime() || 0;
                            }
                            let vv2 = 0;
                            if (v2?.getTime) {
                                vv2 =
                                    new Date(new Date(v2).getFullYear(), new Date(v2).getMonth(), new Date(v2).getDate(), 0, 0, 0, 0).getTime() || 0;
                            }
                            if (vv1 < vv2) {
                                result = -1;
                            }
