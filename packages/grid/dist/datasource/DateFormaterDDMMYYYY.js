...
export class DateFormaterDDMMYYYY {
    ...
    static toSource(value) {
        ...
        returnValue = new Date(x[2], parseInt(x[1], 10) - 1, parseInt(x[0], 10), new Date().getHours(), new Date().getMinutes(), new Date().getSeconds(), new Date().getMilliseconds());
...
//# sourceMappingURL=DateFormaterDDMMYYYY.js.map