...
export class DataContainer {
     ...
     * @returns
     */
    setData(data, add = false, tagAsNew = false) {
        if (!add) {
            this.__collection = [];
        }
        const x = Array.from(data, (o) => {
            if (o?.__controller) {
                ...
                const entity = new Proxy(o, new this.EntityHandler(this.__keyAttribute, tagAsNew));
    ...
    replace(data, index, remove) {
        ...
        const x = Array.from(data, (o) => {
            if (o?.__controller) {
                ...
                return new Proxy(o, new this.EntityHandler(this.__keyAttribute, false));
            }
        });
