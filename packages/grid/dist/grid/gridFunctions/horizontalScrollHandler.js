...
export function horizontalScrollHandler(ctx, scrollLeft, type = MIDDLE_PINNED_COLTYPE) {
    ...
    let idPrefix = MIDDLE_PINNED_COLTYPE;
    /**
    ...
    const getLeftCol = (fromLeft = 0, toRight) => {
        let result = 0;
                            ...
                            if (rowdata?.__group) {
                                ...
                                if (transform !== colEl.style.transform) {
                                    ...
                                    for (let c = 0; c < colEl.children.length; c++) {
                                        renderCell(ctx, colEl.children[c], e.row, x.column, c, idPrefix);
                                    }
                                }
                        ...
                        if (header) {
                            ...
                            if (transform !== header.style.transform) {
                                ...
                                for (let c = 0; c < header.children.length; c++) {
                                    ...
                                    renderCell(ctx, header.children[c], 0, x.column, cellNo, idPrefix);
                                }
                            }
...
//# sourceMappingURL=horizontalScrollHandler.js.map