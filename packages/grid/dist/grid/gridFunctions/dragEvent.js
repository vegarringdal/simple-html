...
export function dragEvent(ctx, cell, sortEnabled = true, abortSignal = undefined) {
    cell.addEventListener('mousedown', (e) => {
        ...
        const cellno = cell.$celno;
        const coltype = cell.$coltype;
        ...
        const mouseup = (event) => {
            ...
            if (dragElement) {
                ...
                if (parent && classList) {
                    const newAttribute = parent.$attribute;
                    const newCellno = parent.$celno;
                    const newColtype = parent.$coltype;
                    const newColumn = parent.$column;
