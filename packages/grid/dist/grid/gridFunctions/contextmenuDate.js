...
export function contextmenuDate(ctx, _event, cell, value, callback) {
    removeContextMenu(ctx);
    const contextMenu = creatElement('div', 'simple-html-grid');
    const config = ctx.gridInterface.__getGridConfig().datePickerConfig || {};
    ...
    const dateElement = creatElement('simple-html-date', 'simple-html-date');
...
//# sourceMappingURL=contextmenuDate.js.map